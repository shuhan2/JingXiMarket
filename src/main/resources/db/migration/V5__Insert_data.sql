...
INSERT INTO Orders (id,productId,productName,quantity,totalPrice,status,buyer,createTime,payTime,cancelTime,finishTime,address,expressId) VALUES
 ( 1, 1,'book',2,60,'CREATED','ZhangS',now(),null,null,null,'WuH',1 );
INSERT INTO Orders (id,productId,productName,quantity,totalPrice,status,buyer,createTime,payTime,cancelTime,finishTime,address,expressId) VALUES
 ( 2, 2,'milk',2,80,'CREATED','Lis','2018-03-11:11:32:23',null,null,null,'WuH',null );
INSERT INTO Orders (id,productId,productName,quantity,totalPrice,status,buyer,createTime,payTime,cancelTime,finishTime,address,expressId) VALUES
 ( 3, 1,'book',2,60,'CREATED','WangW','2018-03-23:10:12:53',null,null,null,'WuH',null );

INSERT INTO Express (id,productId,productName,quantity,status,buyer,courier,orderId) VALUES
 ( 1, 1,'book',2,'NotSetOut','ZhangS','Tony',1 );
